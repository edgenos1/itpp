...
void calculate_instantaneous_CCDF()
{
    ...
    TrellisShaping TSModulator(constellationSize, TSMetricType::Autocorrelation, TSMappingType(TS_MAPPING_TYPE), TSTerminationType(TS_TERMINATION_TYPE));

    ofstream file(join("./Result/TS/CCDF_Norm_", constellationSize, "-QAM_", NUMBER_OF_SUBCARRIERS, "-Sub", "_Type-", TS_MAPPING_TYPE , ".dat"), ios::out);
...
void calculate_average_power_reduction_capability()
{
    ...
    ofstream file(join("./Result/TS/APR_Capa_", constellationSize, "-QAM_", NUMBER_OF_SUBCARRIERS, "-Sub", "_Type-", TS_MAPPING_TYPE , ".dat"), ios::out);
...
void calculate_clipping_ratio_character()
{
    ...
    TrellisShaping TSModulator(constellationSize, TSMetricType::Autocorrelation, TSMappingType(TS_MAPPING_TYPE), TSTerminationType(TS_TERMINATION_TYPE));
    double PAPR;
    ofstream file(join("./Result/TS/Clipping_Chara_", constellationSize, "-QAM_", NUMBER_OF_SUBCARRIERS, "-Sub", "_Type-", TS_MAPPING_TYPE , ".dat"), ios::out);
...
void calculate_uncoded_BER_over_AWGN()
{
    ...
    ofstream file(join("./Result/TS/BER_Uncod_", constellationSize, "-QAM_", NUMBER_OF_SUBCARRIERS, "-Sub", "_Type-", TS_MAPPING_TYPE , ".dat"), ios::out);
...
void calculate_turbo_coded_BER_over_AWGN()
{
    ...
    ofstream file1(join("./Result/TS/BER_turbo_", constellationSize, "-QAM_", NUMBER_OF_SUBCARRIERS, "-Sub", "_Type-", TS_MAPPING_TYPE, ".dat"), ios::out);
    ofstream file2(join("./Result/TS/FER_turbo_", constellationSize, "-QAM_", NUMBER_OF_SUBCARRIERS, "-Sub", "_Type-", TS_MAPPING_TYPE, ".dat"), ios::out);
