#ifndef ItppTurboCode_hpp
#define ItppTurboCode_hpp
...
class ITPP_EXPORT ItppTurboCode
{
public:
...
/*!
  ...
  \endcode
*/
class ITPP_EXPORT Punctured_ItppTurboCode : public ItppTurboCode
{
public:

  //! Class constructor
  Punctured_ItppTurboCode(void) { Period = 0; };

  //! Class destructor
  virtual ~Punctured_ItppTurboCode(void) {}

  /*!
    \brief Set parameters for the punctured turbo encoder/decoder

    the same parameters as with \c ItppTurboCode :
    \param gen1 A vector with \a n1 elements containing the generator polynomials for the first constituent encoder
    \param gen2 A vector with \a n2 elements containing the generator polynomials for the second constituent encoder
    \param constraint_length The constraint length of the two constituent encoders
    \param interleaver_sequence An ivec defining the internal turbo interleaver.
  ...
  */
  int get_punctured_size(void) { it_assert(Period != 0, "Punctured_ItppTurboCode: puncture matrix is not set"); return pNcoded; };
  ...
  */
  ...
  /*!
    ...
    This function can encode (using function from the parent \c ItppTurboCode class) and puncture several consecutive
  ...
  */
  ...
  /*!
    ...
    \param tc Instance of \a Punctured_ItppTurboCode
    ...
    the function)
  */
  friend int calculate_uncoded_size(Punctured_ItppTurboCode &tc, int punctured_size, int &fill_bits);
