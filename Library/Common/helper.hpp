...
namespace helper
{
    ...
    itpp::cvec oversample(const itpp::cvec&, int);                                  // Oversample the sequences.
    itpp::cvec downsample(const itpp::cvec&, int);                                  // Downsample the sequences.
    ...
    itpp::vec calc_normalized_PDF(const itpp::Array<itpp::cvec>&);                  // Make PDF of normalized instantaneous power.
};
